      ...
      <CardContent>
        <article>
          <header>
            ...
            />
            <h4 className="mt-6 sm:mt-8 font-semibold text-lg sm:text-xl text-zinc-800 dark:text-zinc-100 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-colors">
              <Link
                href={link.href}
                target="_blank"
