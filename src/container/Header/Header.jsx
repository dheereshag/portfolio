    ...
    >
      <aside className="flex flex-col gap-4 mt-10 lg:m-10 font-dm-sans w-full lg:w-6/12 xl:w-5/12">
        ...
        <Link
          ...
          className="mt-8 bg-black transform-gpu hover:scale-90 duration-300 text-white text-xl font-bold py-2 px-4 w-44 hover:rounded-full font-poppins flex items-center gap-4"
          target="_blank"
          rel="noreferrer"
        >
          <span>View CV</span>
